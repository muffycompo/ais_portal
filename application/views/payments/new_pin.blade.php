            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            {{ HTML::image('webassets/img/icons/monitor.png') .'  '. HTML::link_to_route('user_dashboard','Dashboard') }} <span class="divider">/</span> New PIN Payment
                                    ...
                                    <div class="span12">
                                        <section class="utopia-widget">
                                            <div class="utopia-widget-title">
                                                ...
                                                <span>New PIN Payment</span>
                                            </div>
                                            @include('template.partials.notification')
                                            <div class="utopia-widget-content">
                                                <div class="row-fluid">
                                                    <div class="span10 utopia-form-freeSpace">
                                                        {{ Form::open('payments/new_pin','POST',array('class'=>'form-horizontal')) }}
                                                            <fieldset>
                                                                ...
                                                                {{ $errors->has('amount')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','amount',Input::old('amount'),array('id'=>'amount','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    {{ Form::button('Add', array('class'=>'btn btn-info span3')) }} {{ HTML::link_to_route('pin_payments','Cancel','',array('class'=>'btn btn-danger span3')) }}
                                                                    </div>
                                                                </div>
