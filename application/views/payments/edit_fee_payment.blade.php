                                    ...
                                    <div class="span12">
                                        <section class="utopia-widget">
                                            <div class="utopia-widget-title">
                                                ...
                                                <span>Edit Fee Payment</span>
                                            </div>
                                            @include('template.partials.notification')
                                            <div class="utopia-widget-content">
                                                <div class="row-fluid">
                                                    <div class="span10 utopia-form-freeSpace">
                                                        {{ Form::open('payments/edit_fee_payment','POST',array('class'=>'form-horizontal')) }}
                                                            <fieldset>
                                                                ...
                                                                {{ $errors->has('admission_no')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','admission_no',$fee_payment->admission_no,array('id'=>'admission_no','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                {{ $errors->has('paid_amount')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','paid_amount',$fee_payment->paid_amount,array('id'=>'paid_amount','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                {{ $errors->has('teller_no')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','teller_no',$fee_payment->teller_no,array('id'=>'teller_no','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Ais::payment_category_dropdown('payment_category_id',$fee_payment->payment_category_id,array('id'=>'payment_category_id','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Ais::class_dropdown('class_id',$fee_payment->class_id,array('id'=>'class_id','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Ais::term_dropdown('term_id',$fee_payment->term_id,,array('id'=>'term_id','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Ais::academic_session_dropdown('academic_session_id',$fee_payment->academic_session_id,array('id'=>'academic_session_id','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    {{ Form::button('Update', array('class'=>'btn btn-info span3')) }}{{ HTML::link_to_route('fee_payments','Cancel','',array('class'=>'btn btn-danger span3')) }}
                                                                    </div>
                                                                </div>
