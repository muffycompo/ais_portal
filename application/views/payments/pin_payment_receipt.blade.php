	...
	<div id="page-wrap">
		...
		<div id="customer">
            <table id="meta">
                ...
                <tr>
                    ...
                    <td><div id="date" class="ta">{{ Ais::reverse_db_date($payment->payment_date) }}</div></td>
                </tr>
                <tr>
                    <td class="meta-head">Amount Paid</td>
                    <td><div class="due">N {{ Ais::format_to_currency($payment->amount) }}</div></td>
                </tr>
		...
		<table id="items">
		  ...
		  <tr class="item-row">
		      ...
		      <td class="description" colspan="4"><strong>{{ Ais::amount_to_words($payment->amount) }} Naira Only.</strong></td>
		  </tr>

		  <tr class="item-row">
		      <td class="item-name">Being Payment for:</td>
		      <td class="description" colspan="4"><strong>Application PIN Slip</strong></td>
		  </tr>
		  ...
		  <tr>
		      ...
		      <td class="total-value"><strong>{{ $payment->accountant }}</strong></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
