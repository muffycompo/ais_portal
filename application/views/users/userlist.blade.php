            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            {{ HTML::image('webassets/img/icons/monitor.png') .'  '. HTML::link_to_route('user_dashboard','Dashboard') }} <span class="divider">/</span> User List
                                                      ...
                                                      @foreach($users as $user)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @if($user->id != Session::get('user_id') && $user->role_id < 6)
