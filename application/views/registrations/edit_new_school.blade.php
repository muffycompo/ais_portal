            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            {{ HTML::image('webassets/img/icons/monitor.png') .'  '. HTML::link_to_route('user_dashboard','Dashboard') }} <span class="divider">/</span> Edit School Attended
                                    ...
                                    <div class="span12">
                                        <section class="utopia-widget">
                                            <div class="utopia-widget-title">
                                                ...
                                                <span>Editing School Attended</span>
                                            </div>
                                            @include('template.partials.notification')
                                            <div class="utopia-widget-content">
                                                <div class="row-fluid">
                                                    <div class="span9 utopia-form-freeSpace">
                                                        {{ Form::open('registrations/edit_new_school','POST',array('class'=>'form-horizontal')) }}
                                                            <fieldset>
                                                                ...
                                                                {{ $errors->has('school_name')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','school_name',$school->school_name,array('id'=>'school_name','class'=>'span6 input-fluid')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Ais::class_dropdown('class_from_id',$school->class_from_id,array('id'=>'class_from_id','class'=>'span6 input-fluid')) }}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Ais::class_dropdown('class_to_id',$school->class_to_id,array('id'=>'class_to_id','class'=>'span6 input-fluid')) }}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                {{ $errors->has('year_from_id')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','year_from_id',$school->year_from,array('id'=>'year_from_id','class'=>'span6 input-fluid ais_date_four','maxlength'=>'4')) }}
                                                                ...
                                                                {{ $errors->has('year_to_id')? '<div class="control-group error">' : '<div class="control-group">' }}
                                                                    ...
                                                                    <div class="controls">
                                                                        {{ Form::input('text','year_to_id',$school->year_to,array('id'=>'year_to_id','class'=>'span6 input-fluid ais_date_four','maxlength'=>'4')) }}
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    {{ Form::button('Update', array('class'=>'btn btn-info span3')) }} {{ HTML::link_to_route('schools_attended','Cancel','',array('class'=>'btn btn-danger span3')) }}
                                                                    </div>
                                                                </div>
