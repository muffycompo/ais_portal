...
-- Records of classes
-- ----------------------------
INSERT INTO `classes` VALUES ('1', 'Nursery 1A');
INSERT INTO `classes` VALUES ('2', 'Nursery 1B');
INSERT INTO `classes` VALUES ('3', 'Nursery 1C');
INSERT INTO `classes` VALUES ('4', 'Nursery 2A');
INSERT INTO `classes` VALUES ('5', 'Nursery 2B');
INSERT INTO `classes` VALUES ('6', 'Nursery 2C');
INSERT INTO `classes` VALUES ('7', 'Nursery 3A');
INSERT INTO `classes` VALUES ('8', 'Nursery 3B');
INSERT INTO `classes` VALUES ('9', 'Nursery 3C');
INSERT INTO `classes` VALUES ('10', 'Primary 1A');
INSERT INTO `classes` VALUES ('11', 'Primary 1B');
INSERT INTO `classes` VALUES ('12', 'Primary 1C');
INSERT INTO `classes` VALUES ('13', 'Primary 2A');
INSERT INTO `classes` VALUES ('14', 'Primary 2B');
INSERT INTO `classes` VALUES ('15', 'Primary 2C');
INSERT INTO `classes` VALUES ('16', 'Primary 3A');
INSERT INTO `classes` VALUES ('17', 'Primary 3B');
INSERT INTO `classes` VALUES ('18', 'Primary 4A');
INSERT INTO `classes` VALUES ('19', 'Primary 4B');
INSERT INTO `classes` VALUES ('20', 'Primary 4C');
INSERT INTO `classes` VALUES ('21', 'Primary 5A');
INSERT INTO `classes` VALUES ('22', 'Primary 5B');
INSERT INTO `classes` VALUES ('23', 'Primary 6A');
INSERT INTO `classes` VALUES ('24', 'JSS 1A');
INSERT INTO `classes` VALUES ('25', 'JSS 1B');
INSERT INTO `classes` VALUES ('26', 'JSS 1C');
INSERT INTO `classes` VALUES ('27', 'JSS 2A');
INSERT INTO `classes` VALUES ('28', 'JSS 2B');
INSERT INTO `classes` VALUES ('29', 'JSS 2C');
INSERT INTO `classes` VALUES ('30', 'JSS 3A');
INSERT INTO `classes` VALUES ('31', 'JSS 3B');
INSERT INTO `classes` VALUES ('32', 'SS1 A');
INSERT INTO `classes` VALUES ('33', 'SS1 B');
INSERT INTO `classes` VALUES ('34', 'SS1 C');
INSERT INTO `classes` VALUES ('35', 'SS2 A');
INSERT INTO `classes` VALUES ('36', 'SS2 B');
INSERT INTO `classes` VALUES ('37', 'SS3 A');
INSERT INTO `classes` VALUES ('38', 'SS3 B');
...
-- ----------------------------
INSERT INTO `payment_categories` VALUES ('1', 'Quarter Fees');
INSERT INTO `payment_categories` VALUES ('2', 'Half Fees');
INSERT INTO `payment_categories` VALUES ('3', 'Full Fees');
INSERT INTO `payment_categories` VALUES ('4', 'Scholarship');
INSERT INTO `payment_categories` VALUES ('5', 'Printing');
INSERT INTO `payment_categories` VALUES ('6', 'Uniforms');
INSERT INTO `payment_categories` VALUES ('7', 'Cafeteria');
INSERT INTO `payment_categories` VALUES ('8', 'WAEC');
INSERT INTO `payment_categories` VALUES ('9', 'NECO');
INSERT INTO `payment_categories` VALUES ('10', 'JSCE');
INSERT INTO `payment_categories` VALUES ('11', 'Common Entrance');
...
CREATE TABLE `schedule_of_fees` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fee_name` varchar(30) DEFAULT NULL,
  `payment_level_id` int(11) NOT NULL,
  `amount` float DEFAULT NULL,
  PRIMARY KEY (`id`,`payment_level_id`),
  KEY `fk_schedule_of_fees_application_type1_idx` (`payment_level_id`),
  CONSTRAINT `fk_schedule_of_fees_application_type1` FOREIGN KEY (`payment_level_id`) REFERENCES `application_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of schedule_of_fees
-- ----------------------------
INSERT INTO `schedule_of_fees` VALUES ('1', 'Nursery Tuition Fee', '1', '20000');
INSERT INTO `schedule_of_fees` VALUES ('2', 'Primary Tuition Fee', '2', '40000');
INSERT INTO `schedule_of_fees` VALUES ('3', 'Junior Secondary Tuition Fee', '3', '60000');
INSERT INTO `schedule_of_fees` VALUES ('4', 'Senior Secondary Tuition Fee', '4', '100000');
...
-- Records of sessions
-- ----------------------------
INSERT INTO `sessions` VALUES ('as2ZzMRA4t85HednOlkQSGoYWftWFyh8bcfCAag4', '1368975247', 'a:9:{s:10:\"csrf_token\";s:40:\"v05vChuBTEedNOCXTtBzH6NG7sBw2fh9yOtMegWq\";s:5:\":new:\";a:0:{}s:5:\":old:\";a:0:{}s:35:\"laravel_auth_drivers_eloquent_login\";i:1;s:7:\"user_id\";i:1;s:5:\"email\";s:16:\"admin@ais.sch.ng\";s:9:\"firstname\";s:3:\"AIS\";s:7:\"surname\";s:13:\"Administrator\";s:7:\"role_id\";i:5;}');
INSERT INTO `sessions` VALUES ('lzTXOg3P4bHRsJpBNTbEenfIi8oSK2VxhAMfrKEp', '1368970765', 'a:3:{s:5:\":new:\";a:0:{}s:5:\":old:\";a:0:{}s:10:\"csrf_token\";s:40:\"vCYv1KwFZbQe3yHXSL7vpfnJgWEzbsqthaINUEsH\";}');
INSERT INTO `sessions` VALUES ('xVOTeihhr0kxBS9eInAKodmXPfEumHWAdS9ZwaDZ', '1368915496', 'a:3:{s:10:\"csrf_token\";s:40:\"L73s7r6cRSq5sCFlGODq4WUivQTNxSyRmCKXwvYx\";s:5:\":new:\";a:0:{}s:5:\":old:\";a:0:{}}');
